...
def test_character_creation_render(character_name="", available_points=10, character_stats={"Health": 10, "Strength": 5, "Speed": 5, "Luck": 1}):
    response = GameResponse(
        ...
        payload={"step": 1, "character_name": character_name, "available_points": available_points, "character_stats": character_stats},
        message=""
    )
...
if __name__ == "__main__":
    test_character_creation_render(None, 10, {"Health": 10, "Strength": 5, "Speed": 5, "Luck": 1})
